...
I put together the ticket below to deploy our new Workforce Planner app. It's a lot simpler than the Uptime OS deployment — no R needed on the server this time.
